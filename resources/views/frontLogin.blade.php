...
<body style="background-color: #666666;">
	...
	<div class="limiter">
		<div class="container-login100">
            ...
            <form action="{{ url('/frontlogin') }}" class="login100-form validate-form" method="post">
					@csrf
					...
					<div  style="margin-bottom: 5%;"class="wrap-input100 validate-input" data-validate = "Valid names is required">
						<input  class="input100" type="text" name="email" value="larry@gmail.com">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="mdp" value="larry">
						<span class="focus-input100"></span>
				...
				<div class="login100-more" style="background-image: url('assets1/images/ok.jpg');">
				</div>
			</div>
		</div>
	</div>
