          ...
          <div class="card">
            <div class="card-body">
              ...
              {{ csrf_field() }}
                  ...
                  <div class="col-md-12">
                      <div class="form-floating">
                      <input type="number" name="nombre" class="form-control" id="floatingZip" placeholder="quantite"  />
                          <label for="floatingZip">quantite</label>
                      </div>
                  </div>
                {{-- <div class="col-md-12">
                    <div class="form-floating">
                    <input type="datetime-local" name="date_depense" class="form-control" id="floatingZip" placeholder="date"  />
                        <label for="floatingZip">date</label>
                    </div>
                </div> --}}
                <div class="col-md-6">
                    <div class="form-floating">
