  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <img src={{url("assets/img/logo.png") }} alt="" >
        <span class="d-none d-lg-block">Clinique Larry</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Larry</span>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ url('/listePatient') }}">
              <i class="bi bi-circle"></i><span>Patient</span>
            </a>
          </li>

          <li>
            <a href="{{ url('/listeTypedepense') }}">
              <i class="bi bi-circle"></i><span>type depense</span>
            </a>
          </li>
          <li>
            <a href="{{ url('/listeTyperecette') }}">
              <i class="bi bi-circle"></i><span>type recette</span>
            </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Statistique </span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ url('/listeStatistique') }}">
